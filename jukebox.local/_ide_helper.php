 ...
 * Generated for Laravel 5.2.39 on 2016-12-07.
 *
...
namespace {
    ...
    class Twig extends \TwigBridge\Facade\Twig{
        ...
        public static function hasExtension($name){
            //Method inherited from \Twig_Environment            
            return \TwigBridge\Bridge::hasExtension($name);
        }
        ...
        public static function getExtension($name){
            //Method inherited from \Twig_Environment            
            return \TwigBridge\Bridge::getExtension($name);
        }
    ...
    class lxmpd extends \Dcarrith\LxMPD\LxMPDFacade{
        
        /**
         * Start up MPD.
         *
         * @param $binary The path to the MPD binary
         * @param $conf The path to the user's MPD conf file
         * @return \Dcarrith\LxMPD\result 
         * @static 
         */
        public static function start($binary = null, $conf = null){
            return \Dcarrith\LxMPD\LxMPD::start($binary, $conf);
        }
         ...
         */
        public static function authenticate(){
            return \Dcarrith\LxMPD\LxMPD::authenticate();
        }
         ...
         * @static 
         */
        public static function runCommand($command, $args = array(), $timeout = 86400){
            return \Dcarrith\LxMPD\LxMPD::runCommand($command, $args, $timeout);
        }
        ...
        public static function refreshInfo(){
            return \Dcarrith\LxMPD\LxMPD::refreshInfo();
        }
        ...
        public static function idle($subsystems = array()){
            return \Dcarrith\LxMPD\LxMPD::idle($subsystems);
        }
        
        /**
         * GetFirstTrack gets the first track of an album
         *
         * @param \Dcarrith\LxMPD\scope_key  is to give scope to the find command
         * @param \Dcarrith\LxMPD\scope_value  is the value of the scope
         * @return \Dcarrith\LxMPD\firstTrack 
         * @static 
         */
        public static function getFirstTrack($scope_key = 'album', $scope_value = null){
            return \Dcarrith\LxMPD\LxMPD::getFirstTrack($scope_key, $scope_value);
        }
         ...
         * @static 
         */
        public static function getEssentialTags(){
            return \Dcarrith\LxMPD\LxMPD::getEssentialTags();
        }
         ...
         * @static 
         */
        public static function reportOnMissingTags($command, $tracks){
            \Dcarrith\LxMPD\LxMPD::reportOnMissingTags($command, $tracks);
        }
         ...
         * @static 
         */
        public static function filterOutUnwantedTags($tracks){
            return \Dcarrith\LxMPD\LxMPD::filterOutUnwantedTags($tracks);
        }
         ...
         * @static 
         */
        public static function playlistExists($name){
            return \Dcarrith\LxMPD\LxMPD::playlistExists($name);
        }
        ...
        public static function isConnected(){
            return \Dcarrith\LxMPD\LxMPD::isConnected();
        }
        ...
        public static function get($name){
            return \Dcarrith\LxMPD\LxMPD::get($name);
        }
         ...
         * If the property is not yet defined, then it returns null.
         *
         * @param \Dcarrith\LxMPD\function  The MPD function to call
         * @param \Dcarrith\LxMPD\args  The string or array of arguments to pass into the function call
         * @return mixed 
         * @static 
         */
        public static function call($function, $arguments = array()){
            return \Dcarrith\LxMPD\LxMPD::call($function, $arguments);
        }
         ...
         * @static 
         */
        public static function play($resume = true){
            return \Dcarrith\LxMPD\LxMPD::play($resume);
        }
         ...
         */
        public static function previous(){
            return \Dcarrith\LxMPD\LxMPD::previous();
        }
        ...
        public static function next(){
            return \Dcarrith\LxMPD\LxMPD::next();
        }
        ...
        public static function getCurrentTrack(){
            return \Dcarrith\LxMPD\LxMPD::getCurrentTrack();
        }
         ...
         * @static 
         */
        public static function getEnhancedPlaylist(){
            return \Dcarrith\LxMPD\LxMPD::getEnhancedPlaylist();
        }
         ...
         * @static 
         */
        public static function enhanceTrackDetails($track, $index = null){
            return \Dcarrith\LxMPD\LxMPD::enhanceTrackDetails($track, $index);
        }
         ...
         * @static 
         */
        public static function getAlbumArt($filepath, $artist, $album){
            return \Dcarrith\LxMPD\LxMPD::getAlbumArt($filepath, $artist, $album);
        }
         ...
         * @static 
         */
        public static function getTimerDisplay($timer_input){
            return \Dcarrith\LxMPD\LxMPD::getTimerDisplay($timer_input);
        }
        ...
        public static function toJson(){
            return \Dcarrith\LxMPD\LxMPD::toJson();
        }
        ...
        public static function getStatus(){
            return \Dcarrith\LxMPD\LxMPD::getStatus();
        }
